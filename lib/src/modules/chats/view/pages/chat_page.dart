...
import 'package:chaseapp/src/shared/widgets/chat/message_tile.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  _sendMessage() {
    if (messageEditingController.text.isNotEmpty) {
      ...
      DatabaseService(uid: widget.uid)
          .sendMessage(widget.chaseId, chatMessageMap);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text(widget.chaseName, style: const TextStyle(color: Colors.white)),
        centerTitle: true,
