...
import 'package:chaseapp/shared/constants.dart';
          ...
          child: ListView(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text("ChaseApp", style: TextStyle(color: Colors.white, fontSize: 40.0, fontWeight: FontWeight.bold)),
                  ...
                  TextFormField(
                    ...
                    validator: (val) => val.length < 6 ? 'Seriously? Choose a better password..' : null,
                    obscureText: true,
                    onChanged: (val) {
                      setState(() {
                        password = val;
